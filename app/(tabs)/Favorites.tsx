  ...
  const renderProductCard = (item: any) => (
    ...
    >
      ...
      <View style={{ padding: 10 }}>
        ...
        {/* Price */}
        <Text style={{ fontWeight: '800', fontSize: 13, color: AppColors.primary, marginBottom: 8 }}>{formatPriceFromAPI(item.price)}</Text>
    ...
    >
      ...
      <View style={{ flex: 1, justifyContent: 'space-between' }}>
        <View>
          ...
          <Text style={{ fontWeight: '800', fontSize: 14, color: AppColors.primary }}>{formatPriceFromAPI(item.price)}</Text>
        </View>
